...
class ProfileViewModel @Inject constructor(
    ...
    private val _isAnalyticsEnabled = MutableStateFlow(settingsManager.isAnalyticsEnabled)
    val isAnalyticsEnabled: StateFlow<Boolean> = _isAnalyticsEnabled

    private val _defaultServerIndex = MutableStateFlow(settingsManager.defaultServerIndex)
    val defaultServerIndex: StateFlow<Int> = _defaultServerIndex
    ...
    fun setDefaultServer(index: Int) {
        settingsManager.defaultServerIndex = index
        _defaultServerIndex.value = index
    }
