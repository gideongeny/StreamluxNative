    ...
    fun search(query: String) {
        ...
        viewModelScope.launch {
            ...
            try {
                ...
                val movies = tmdbRepository.fetch("/search/movie", query = normalizedQuery).results ?: emptyList()
                val tvShows = tmdbRepository.fetch("/search/tv", query = normalizedQuery).results ?: emptyList()
