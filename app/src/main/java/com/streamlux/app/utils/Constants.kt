...
object Constants {
    ...
    val GOOGLE_WEB_CLIENT_ID = BuildConfig.GOOGLE_WEB_CLIENT_ID.ifEmpty { "242283846154-t9ji7cvhfbobegog438kgdvedf2nq5ra.apps.googleusercontent.com" }
    ...
    /** Firebase Hosting → Functions gateway (preferred; shared with website) */
    const val API_GATEWAY_BASE = "https://streamlux-67a84.web.app/api/"
    /** Direct Cloud Functions URL (fallback) */
    ...
    val SERP_API_KEY = BuildConfig.SERP_API_KEY
